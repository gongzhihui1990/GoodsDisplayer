...
public class BaseActivity extends AppCompatActivity {
    ...
    private void startBug() {
        ...
        bugSubscribe = Observable.interval(10, 10, TimeUnit.SECONDS)
                ...
                .subscribe(new Consumer<Long>() {
                    ...
                    public void accept(@NonNull Long aLong) throws Exception {
                        ...
                        }else {                            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS | WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
